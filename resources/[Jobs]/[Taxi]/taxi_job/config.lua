...
Config.jeveuxblips = true --- true = Oui | false = Non
...
Config.pos = {
		coffre = {
		position = {x = 894.23, y = -171.42, z = 74.68}
	},
		garage = {
		position = {x = 913.94, y = -159.91, z = 74.38}
	},
		spawnvoiture = {
		position = {x = 913.94, y = -159.91, z = 74.38, h = 192.79}
	},
		boss = {
		position = {x = 903.70, y = -162.46, z = 78.16}
	},
		blip = {
		position = {x = 914.56, y = -179.67, z = 74.13}
	},
}

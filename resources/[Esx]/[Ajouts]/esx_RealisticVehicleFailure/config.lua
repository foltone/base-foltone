...
--[[cfg = {
	...
	damageFactorPetrolTank = 45.0,				-- Sane values are 1 to 200. Higher values means more damage to vehicle. A good starting point is 64
	...
	weaponsDamageMultiplier = 0.10,				-- How much damage should the vehicle get from weapons fire. Range 0.0 to 10.0, where 0.0 is no damage and 10.0 is 10x damage. -1 = don't touch
...
cfg = {
	...
	classDamageMultiplier = {
		...
		[3] =	0.45,		--	3: Coupes
		[4] =	0.5,		--	4: Muscle
		[5] =	0.45,		--	5: Sports Classics
		[6] =	0.45,		--	6: Sports
		[7] =	0.45,		--	7: Super
		[8] =	0.07,		--	8: Motorcycles
		[9] =	0.3,		--	9: Off-road
		[10] =	0.9,		--	10: Industrial
		[11] =	0.15,		--	11: Utility
		[12] =	0.35,		--	12: Vans
		[13] =	0.5,		--	13: Cycles
		[14] =	0.0,		--	14: Boats
		[15] =	0.3,		--	15: Helicopters
		[16] =	0.3,		--	16: Planes
		[17] =	0.45,		--	17: Service
		[18] =	0.45,		--	18: Emergency
		[19] =	0.37,		--	19: Military
		[20] =	0.23,		--	20: Commercial
		[21] =	0.5			--	21: Trains
	}
}

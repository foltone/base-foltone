...
Config.Strings = {
	...
	EToRefuel = "Appuyez sur ~g~E ~w~faire le plein du véhicule",
	JerryCanEmpty = "Le jerrican est vide",
	FullTank = "Réservoir est plein",
	PurchaseJerryCan = "Appuyez sur ~g~E ~w~acheter un jerrican pour ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "Appuyez sur ~g~E ~w~ pour stoper le plein",
	CancelFuelingJerryCan = "Appuyez sur ~g~E ~w~pour stoper le plein",
	NotEnoughCash = "Pas assez d'argent",
	RefillJerryCan = "Appuyez sur ~g~E ~w~ remplir le jerrican pour ~g~$",
...
if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Appuyez sur ~g~E ~w~prendre un jerrican"
	Config.Strings.RefillJerryCan = "Appuyez sur ~g~E ~w~ pour remplir le jerrican"
end

...
files {
	...
	'html/img/header/moderation.png',
	...
	'html/img/header/bahama.png',
	'html/img/header/pompistes.png',
	'html/img/header/lsmc.png',
	'html/img/header/immobilier.png',
	'html/img/header/unicorn.png',
	'html/img/header/tabac.png',
	'html/img/header/vignerons.png',
	'html/img/header/police.png',
	'html/img/header/nightclub.png',
	'html/img/header/gouvernement.png',
	'html/img/header/vestiaire.png'

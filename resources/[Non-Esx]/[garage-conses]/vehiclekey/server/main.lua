...
ESX.RegisterServerCallback('ddx_society:isowned', function(source, cb, plate, jobs)
...
ESX.RegisterServerCallback('ddx_vehiclelock:getVehiclesnokeycardealer', function(source, cb, target)
...
-- Donné les clé
RegisterServerEvent('ddx_vehiclelock:givekeycardealer')
AddEventHandler('ddx_vehiclelock:givekeycardealer', function(target, plate)
local _source = source
local xPlayer = nil
local toplate = plate
...
RegisterServerEvent('ddx_vehiclelock:deletekeycardealer')
AddEventHandler('ddx_vehiclelock:deletekeycardealer', function(target, plate)
local _source = source
local xPlayer = nil
local toplate = plate
xPlayer = ESX.GetPlayerFromId(_source)
...
RegisterServerEvent('ddx_vehiclelock:registerkeycardealer')
AddEventHandler('ddx_vehiclelock:registerkeycardealer', function(plate, target)
local _source = source
local xPlayer = nil
if target == 'no' then
	 xPlayer = ESX.GetPlayerFromId(_source)
...
ESX.RegisterServerCallback('ddx_vehiclelock:allkey', function(source, cb)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
...
RegisterServerEvent('ddx_vehiclelock:deletekeyjobs')
AddEventHandler('ddx_vehiclelock:deletekeyjobs', function(target, plate)
local _source = source
local xPlayer = nil
local toplate = plate
...
-- Donné un double
RegisterServerEvent('ddx_vehiclelock:givekey')
AddEventHandler('ddx_vehiclelock:givekey', function(target, plate)
local _source = source
local xPlayer = ESX.GetPlayerFromId(_source)
local toplate = plate
...
--Perte des clés 
RegisterServerEvent('ddx_vehiclelock:onplayerdeath')
AddEventHandler('ddx_vehiclelock:onplayerdeath', function()
local _source = source
local xPlayer = ESX.GetPlayerFromId(_source)
...
RegisterServerEvent('ddx_vehiclelock:changeowner')
AddEventHandler('ddx_vehiclelock:changeowner', function(target, plate)
local _source = source
local xPlayer = nil
local toplate = plate
xPlayertarget = ESX.GetPlayerFromId(target)
...
------ Donné clé
RegisterServerEvent('ddx_vehiclelock:donnerkey')
AddEventHandler('ddx_vehiclelock:donnerkey', function(target, plate)
local _source = source
local xPlayer = nil
local toplate = plate
xPlayertarget = ESX.GetPlayerFromId(target)
...
------- Préter clé
RegisterServerEvent('ddx_vehiclelock:preterkey')
AddEventHandler('ddx_vehiclelock:preterkey', function(target, plate)
local _source = source
local xPlayer = nil
local toplate = plate
xPlayertarget = ESX.GetPlayerFromId(target)
